...
//             <ul>
//                 <li>
//                     <div className='flex border border-gray-500' style={{ padding: '0.6rem 1.25rem' }}>
...
//                                 <SentimentSatisfiedAltIcon style={{ height: '30px', width: '30px', color: 'white', cursor: 'pointer' }} onClick={toggleEmojiPicker} />
...
//                                 {/* <CameraAltOutlinedIcon style={{ height: '30px', width: '30px', color: 'white' }} /> */}
//                                 <button type="button" className="focus:outline-none text-white bg-green-500 hover:bg-green-500 focus:ring-4 focus:ring-green-500 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 dark:bg-green-500 dark:hover:bg-green-500 dark:focus:ring-green-500" onClick={handleSubmit}>Post</button>
//                                 {showEmojiPicker && (
//                                     <div className="absolute top-[3rem] right-0 z-50">
...
//                                                         {x.contentSubTitle && (
//                                                             <p className="text-[0.75rem] text-[#8c9097] mb-0">{x.contentSubTitle}</p>
//                                                         )}

//                                                         {x.url && (
//                                                             <p className="text-[0.75rem] text-[#8c9097] mb-0"><a href={x.url} className="text-blue-500">{x.url}</a></p>
//                                                         )}
//                                                         {x.img ? <img src={x.img} className='h-[70px] mt-2 mb-2 rounded-lg '/> : null}
//                                                     </div>
...
//                                                         <span className="bg-green-100 text-green-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded dark:bg-green-900 dark:text-green-300"><ThumbUpAltOutlinedIcon style={{ height: '13px', width: '13px', color: 'green' }} /></span>
//                                                         <span className="bg-pink-100 text-pink-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded dark:bg-pink-900 dark:text-pink-300"><ShareOutlinedIcon style={{ height: '13px', width: '13px', color: 'pink' }} /></span>
//                                                     </div>
//                                                 </div>
//                                             </div>
//                                             <div>
//                                                 <DeleteIcon className='h-[20px] w-[20px] text-white cursor-pointer mr-4' onClick={() => handleDelete(x.id)} />
//                                                 {x.tags && (
//                                                     <span className={`bg-${x.tags.includes('Nature') ? 'green' : x.tags.includes('Travel') ? 'blue' : 'purple'}-100 text-${x.tags.includes('Nature') ? 'green' : x.tags.includes('Travel') ? 'blue' : 'purple'}-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded dark:bg-purple-900 dark:text-purple-300`}>{x.tags}</span>
//                                                 )}
